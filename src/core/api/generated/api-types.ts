...
export interface paths {
    ...
    "/api/v1/billing/paddle-checkout": {
        ...
        post: operations["billingCreatePaddleCheckout"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/billing/paddle-webhook": {
        ...
        put?: never;
        /** HandlePaddleWebhook */
        post: operations["billingHandlePaddleWebhook"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/profile/export": {
        ...
        put?: never;
        /** ExportData */
        post: operations["profileExportData"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/memory/facts": {
        ...
        /** ListMemoryFacts */
        get: operations["conversationsListMemoryFacts"];
        put?: never;
        /** AddMemoryFact */
        post: operations["conversationsAddMemoryFact"];
        /** ForgetAllMemoryFacts */
        delete: operations["conversationsForgetAllMemoryFacts"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/api/v1/memory/facts/{id}": {
        ...
        post?: never;
        /** ForgetMemoryFact */
        delete: operations["conversationsForgetMemoryFact"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
...
export interface operations {
    ...
    billingCreatePaddleCheckout: {
        ...
        requestBody: {
            content: {
                "application/json": {
                    ...
                    checkoutUrl?: string;
                    /** @example pri_01m340f2f38cbr9ndj77bmpbzc */
                    priceId: string;
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": {
                        /** @example https://checkout.paddle.com/... */
                        checkoutUrl?: string;
                        /** @example txn_01... */
    ...
    billingCreateCustomerPortalSession: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": {
                        /** @example https://customer-portal.paddle.com/... */
                        portalUrl?: string;
                    };
                };
            };
    ...
    profileExportData: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": {
                        /** @example https://minio.local/exports/user-123-abc.json */
                        downloadUrl?: string;
                    };
                };
            };
    ...
    conversationsForgetAllMemoryFacts: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
