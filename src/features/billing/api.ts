/**
 * Billing API — overview (plans, subscription, entitlements), customer portal,
 ...
 * the portal endpoint opens the Paddle customer portal for web-billed
 * subscribers. Upgrade events are tracked to the backend for analytics.
 */
